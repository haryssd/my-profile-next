  ...
  return (
    <>
      <div className="group h-full rounded-xl transition-all duration-300 hover:scale-[1.01]">
        <div className="h-full bg-gray-900 rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-500 overflow-hidden relative">
          <div className="h-full flex flex-col justify-between relative z-10">
            ...
            <div>
              ...
              <p className="text-md text-gray-300 group-hover:text-white leading-relaxed mb-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="group/aboutme px-4 py-2 rounded-lg border border-gray-600 bg-gray-800/80 hover:bg-gray-700 transition-all duration-300 hover:scale-[1.03]"
              >
