export default function ProfileCard() {
  return (
    <div className="group bg-[#f7f7f7] hover:bg-[#eeeeee] border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.01] h-full overflow-hidden">
      {/* Header Section */}
